import mongoose, { Schema, ConnectOptions, Types } from "mongoose";
...
const PatientModel = mongoose.model<IPatient>("Patients", patientSchema);
...
await mongoose
  .connect(
    "mongodb+srv://aslambaba:aslambaba91r@maindatabase.mxkbqt7.mongodb.net/?retryWrites=true&w=majority",
    {
...
const resolvers = {
  ...
  Mutation: {
    ...
    updateDoctor: async (_, { doctor }) => {
      console.log(doctor);
      let a = await DoctorModel.findOneAndUpdate(
